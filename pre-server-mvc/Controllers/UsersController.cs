...
namespace pre_server_mvc.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(PrsDBDbApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,Firstname,Lastname,Phone,Email,IsReview,IsAdmin")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,Firstname,Lastname,Phone,Email,IsReview,IsAdmin")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
